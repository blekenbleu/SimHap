			...
			double maxRPMFromGame)
		{
			try
			{
				...
				if (jobject["data"].HasValues)
				{
					...
					v.EngineCylinders = jtoken["ctl"].ToObject<double>();
					v.Redline = jtoken["redline"].ToObject<double>();
					v.MaxRPM = jtoken["maxrpm"].ToObject<double>();
					v.MaxPower = jtoken["hp"].ToObject<double>();
					v.ElectricMaxPower = jtoken["ehp"].ToObject<double>();
					v.Displacement = jtoken["cc"].ToObject<double>();
					v.MaxTorque = jtoken["nm"].ToObject<double>();
