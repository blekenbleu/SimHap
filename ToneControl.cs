...
namespace sierses.Sim
{
	...
	public partial class SettingsControl : UserControl
	{
		...
		private void H_Click(object sender, RoutedEventArgs e)
		{
			...
			int b = 1 + Plugin.E.Tones[0].Freq[8];
		...
		private void HSlider(object sender, RoutedPropertyChangedEventArgs<double> e)
		{
			...
			int a = Plugin.E.Tones[0].Freq[8];	// index to pair of Tones
			...
			if (1 < i)	// sliders [<2] are modulation and fundamental peak amplitudes, not harmonic factors
			{
				...
				if (-1 == i)
					i = 8;
				harmonic[a + 1].Freq[i] = Convert.ToUInt16(0.1 + s.Value);
			}
			InitHarmonics(Plugin.E.Tones);
		}
	}
